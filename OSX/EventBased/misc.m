...
void initPreDefined()
{
	...
	newPreDefined(pdVK_OEM_PLUS,	L"VK_OEM_PLUS",		L"\x003d");
	newPreDefined(pdVK_OEM_COMMA,	L"VK_OEM_COMMA",	L"\x002c");
	newPreDefined(pdVK_OEM_MINUS,	L"VK_OEM_MINUS",	L"\x002d");
	newPreDefined(pdVK_OEM_PERIOD,	L"VK_OEM_PERIOD",	L"\x002e");
	
	newPreDefined(pdVK_OEM_2,	L"VK_OEM_2",	L"\x002f"); //0x00BF
	newPreDefined(pdVK_OEM_2,	L"VK_QUESTION",	L"\x002f");
	
	newPreDefined(pdVK_OEM_3,	L"VK_OEM_3",	L"\x0060");
	newPreDefined(pdVK_OEM_3,	L"VK_CFLEX",	L"\x0060");
	
	newPreDefined(pdVK_OEM_4,	L"VK_OEM_4",	L"\x005b");
	newPreDefined(pdVK_OEM_4,	L"VK_LBRACKET",	L"\x005b");
	
	newPreDefined(pdVK_OEM_5,	L"VK_OEM_5",	L"\x005c");
	newPreDefined(pdVK_OEM_5,	L"VK_BACKSLASH",L"\x005c");
	
	newPreDefined(pdVK_OEM_6,	L"VK_OEM_6",	L"\x005d");
	newPreDefined(pdVK_OEM_6,	L"VK_RBRACKET",	L"\x005d");
	
	newPreDefined(pdVK_OEM_7,	L"VK_OEM_7",	L"\x0027");
	newPreDefined(pdVK_OEM_7,	L"VK_QUOTE",	L"\x0027");
	...
	newPreDefined(pdVK_OEM_102,	L"VK_OEM_102",	L"\x002c");
	newPreDefined(pdVK_OEM_102,	L"VK_LESSTHEN",	L"\x002c");

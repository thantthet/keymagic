...
zip ./../keymagic/OSX/package/resource/others/kbLayouts "Zawgyi/Zawgyi.km2" "ZawCode/ZawCode.km2" "Pyidaungsu/Pyidaungsu MM.km2" "PaOh/PaOh.km2" "Yunghkio/Yunghkio SHAN.km2"
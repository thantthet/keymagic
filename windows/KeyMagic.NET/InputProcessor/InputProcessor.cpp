...
//		//If no focus
//		if (!GetFocus()) {
//			DebugPrint(L"No Focus:(%s)PID=%d,TID=%d,FGW=%X\n", DllName, GetCurrentProcessId(), GetCurrentThreadId(), GetForegroundWindow());
//			return CallNextHookEx(hKeyHook, nCode, wParam, lParam);
//		}
//
//		DebugPrint(L"HookKeyProc:(%s)PID=%d,TID=%d,FGW=%X\n", DllName, GetCurrentProcessId(), GetCurrentThreadId(), GetForegroundWindow());
//
